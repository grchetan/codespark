...
export const adminUsers: AdminUser[] = [
  { id: 'u1', name: 'Aarav Sharma', email: 'aarav@codespark.dev', role: 'member', status: 'active', joined: '2026-07-02', effects: 4, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u2', name: 'Priya Mehta', email: 'priya@codespark.dev', role: 'member', status: 'active', joined: '2026-07-11', effects: 7, avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u3', name: 'Rohan Verma', email: 'rohan@codespark.dev', role: 'member', status: 'banned', joined: '2026-06-18', effects: 2, avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=120&h=120&q=80', reports: 4 },
  { id: 'u4', name: 'Isha Kapoor', email: 'isha@codespark.dev', role: 'member', status: 'active', joined: '2026-08-01', effects: 1, avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u5', name: 'Kabir Singh', email: 'kabir@codespark.dev', role: 'moderator', status: 'active', joined: '2026-05-20', effects: 12, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u6', name: 'Meera Nair', email: 'meera@codespark.dev', role: 'member', status: 'pending', joined: '2026-08-22', effects: 0, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u7', name: 'Vivaan Gupta', email: 'vivaan@codespark.dev', role: 'member', status: 'active', joined: '2026-07-28', effects: 3, avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=120&h=120&q=80' },
  { id: 'u8', name: 'Chetan Prajapat', email: 'chetan@codespark.dev', role: 'admin', status: 'active', joined: '2026-03-08', effects: 24, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&h=120&q=80' },
];
