...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-background-50 flex flex-col justify-between">
      ...
      {/* Main Full-Width 2-Column Authentication Layout */}
      <main className="w-full flex-1 flex flex-col lg:flex-row pt-16 md:pt-[104px]">
        {/* ================================================================= */}
        ...
        {/* ================================================================= */}
        {/* RIGHT COLUMN: 40-45% VERTICALLY CENTERED LOGIN CARD               */}
        {/* ================================================================= */}
        <div className="w-full lg:w-[42%] flex items-center justify-center p-4 sm:p-8 lg:p-12 min-h-[calc(100vh-104px)]">
